...
const navigation = [
  ...
  { name: 'About us', href: 'InterviewPage' },
  { name: 'Tips', href: '' },
...
const tiers = [
    {
      ...
      description: 'Perfect for practising your interview skills with immediate feedback after each answer.',
    ...
    },
    {
      ...
      description: 'For those who want to take the practise wheels off a bit but still have that post interview feedback.',
      features: [
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              ...
              <a href="#Updates" className="font-semibold text-indigo-600">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Practise your Interviewing skills with us by getting personalised tips on your answers so you can nail your next one.
            </p>
